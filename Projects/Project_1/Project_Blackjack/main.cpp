...
int main(int argc, char** argv) {
    ...
    unsigned int p1,p2,d1,d2,pTotal,dTotal,
            pp1,pp2,dd1,dd2,games;
    string pCards,dCards,dispD2;
    char choice;
    ...
    //Second dealer card
    switch (dd2){
        case 1:dCards+="2 ";dispD2='2';break;
        case 2:dCards+="3 ";dispD2='3';break;
        case 3:dCards+="4 ";dispD2='4';break;
        case 4:dCards+="5 ";dispD2='5';break;
        case 5:dCards+="6 ";dispD2='6';break;
        ...
        case 13:dCards+="A ";dispD2='A';break;
    }
    if (d2<=9&&d2>=1){
        d2+=1;
    }
    ...
    cout<<"The dealer is showing a "<<dispD2<<endl;
    cout<<endl;
